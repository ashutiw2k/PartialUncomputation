...
import rustworkx
from helperfunctions.uncompfunctions import greedy_uncomputation_full, greedy_uncomputation_full_per_node
...
uncomp_graph = greedy_uncomputation_full_per_node(comp_graph, ancillas_list)
