...
def get_probability_metrics(num_q, num_a, num_g, results=ProbDiffResults,
    ...
    for idx in range(num_circuits):
        ...
        if has_cycle:
            ...
            ex_vals = get_difference_in_prob(_circuit, _exhaustive_uncomp_circuit,num_q, num_a, distance=distance, normalized=False)
    ...
    # ***************************************************************************************************************#
            ...
            gf_vals = get_difference_in_prob(_circuit, _greedy_uncomp_circuit, num_q, num_a, distance=distance, normalized=False)
    ...
    #**************************************************************************************************************#
            ...
            gp_vals = get_difference_in_prob(_circuit, _greedy_partial_uncomp_circuit, num_q, num_a, distance=distance, normalized=False)
    ...
    #**************************************************************************************************************#
            ...
            reg_vals = get_difference_in_prob(_circuit, _uncomp_circuit, num_q, num_a, distance=distance, normalized=False)
