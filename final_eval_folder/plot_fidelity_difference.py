...
from helperfunctions.evaluation import FidelityResults, get_fidelitys, plot_results, plot_results_bar

def get_probability_metrics(num_q, num_a, num_g, results=FidelityResults,
    ...
    for idx in range(num_circuits):
        ...
        if has_cycle:
            ...
            ex_vals = get_fidelitys(_circuit, _exhaustive_uncomp_circuit,num_q, num_a)
    ...
    # ***************************************************************************************************************#
            ...
            gf_vals = get_fidelitys(_circuit, _greedy_uncomp_circuit, num_q, num_a)
    ...
    #**************************************************************************************************************#
            ...
            gp_vals = get_fidelitys(_circuit, _greedy_partial_uncomp_circuit, num_q, num_a)
    ...
    #**************************************************************************************************************#
            ...
            reg_vals = get_fidelitys(_circuit, _uncomp_circuit, num_q, num_a)
...
def metrics_for_ancillas(config):
    ...
    for var in range(num_a_min, num_a_max+num_a_step, num_a_step):
        filled_results = get_probability_metrics(num_q=num_q, num_g=num_g, num_a=var, 
                                             results=FidelityResults(num_circuits), num_circuits=num_circuits,
                                             )
    ...
    plot_results_bar(results_dict, figname=f'Plot_fidelity{num_q}q_{num_g}g_{num_a_min}-{num_a_max}a_{num}_bar',
                 image_write_path=image_write_path, xlabel='Number of Ancillary Qubits')
    
    plot_results(results_dict, figname=f'Plot_fidelity{num_q}q_{num_g}g_{num_a_min}-{num_a_max}a_{num}_line',
                 image_write_path=image_write_path, xlabel='Number of Ancillary Qubits')
...
def metrics_for_inputs(config):
    ...
    plot_results_bar(results_dict, figname=f'Plot_fidelity{num_q_min}-{num_q_max}q_{num_g}g_{num_a}a_{num}_bar',
                 image_write_path=image_write_path, xlabel='Number of Input Qubits')
    
    plot_results(results_dict, figname=f'Plot_fidelity{num_q_min}-{num_q_max}q_{num_g}g_{num_a}a_{num}_line',
                 image_write_path=image_write_path, xlabel='Number of Input Qubits')
...
def metrics_for_gates(config):
    ...
    plot_results_bar(results_dict, figname=f'Plot_fidelity{num_q}q_{num_g_min}-{num_g_max}g_{num_a}a_{num}_bar',
                 image_write_path=image_write_path, xlabel='Number of (C-Not) Gates')

    plot_results(results_dict, figname=f'Plot_fidelity{num_q}q_{num_g_min}-{num_g_max}g_{num_a}a_{num}_line',
                 image_write_path=image_write_path, xlabel='Number of (C-Not) Gates')
...
if __name__ == '__main__':
    ...
    # plot_results_bar(results_dict, figname=f'Plot_num_ancillas_uncomputed_{num_q}q_{num_g}g_{num_a_min}-{num_a_max}a_{num}',
    #              image_write_path=image_write_path, xlabel='Number of Ancillary Qubits')
