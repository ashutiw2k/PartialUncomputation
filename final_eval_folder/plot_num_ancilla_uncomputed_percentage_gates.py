...
from helperfunctions.evaluation import NumAncillaUncomped, get_difference_in_prob, plot_ancilla_results, plot_ancillas_bar
...
def metrics_for_cc_gates(config):
    ...
    # plot_ancillas_bar(results_dict, figname=f'Plot_num_ancilla_uncomp{num_q}q_{num_g}g_{num_a_min}-{num_a_max}a_bar',
    #              image_write_path=image_write_path, xlabel='Number of Ancillary Qubits')
    
    plot_ancilla_results(results_dict, figname=f'Plot_num_ancilla_uncomp{num_q}q_{num_g}g_{num_a}a_percent_cc',
                 image_write_path=image_write_path, xlabel='Percentage Of Input-Input Gates')
...
def metrics_for_ca_gates(config):
    ...
    plot_ancilla_results(results_dict, figname=f'Plot_num_ancilla_uncomp{num_q}q_{num_g}g_{num_a}a_percent_ca',
                 image_write_path=image_write_path, xlabel='Percentage Of Input-Ancilla Gates')
...
def metrics_for_ac_gates(config):
    ...
    plot_ancilla_results(results_dict, figname=f'Plot_num_ancilla_uncomp{num_q}q_{num_g}g_{num_a}a_percent_ac',
                 image_write_path=image_write_path, xlabel='Percentage Of Ancilla-Input Gates')
...
def metrics_for_aa_gates(config):
    ...
    plot_ancilla_results(results_dict, figname=f'Plot_num_ancilla_uncomp{num_q}q_{num_g}g_{num_a}a_percent_aa',
